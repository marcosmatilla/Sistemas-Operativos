...
# 159 "OperatingSystem.c" 3 4
# 160 "OperatingSystem.c" 
...
ComputerSystem_DebugMessage(550, 'p', "response time", executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName), response_time); 
#line 431 "OperatingSystem.c"
OperatingSystem_ShowTime('p'); 
#line 432 "OperatingSystem.c"
ComputerSystem_DebugMessage(550, 'p', "return time", executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName), return_time); 
#line 434 "OperatingSystem.c"
OperatingSystem_ShowTime('p'); 
#line 435 "OperatingSystem.c"
ComputerSystem_DebugMessage(550, 'p', "waiting time", executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName), waiting_time); 
